                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-outline-primary"
                                        href="{{ route('admin.emploi_du_temps.show', ['emploi_du_temp' => $e->id]) }}">Voir</a>
                                    <a class="btn btn-sm btn-outline-warning"
                                        href="{{ route('admin.emploi_du_temps.edit', ['emploi_du_temp' => $e->id]) }}">Modifier</a>
                                    <form action="{{ route('admin.emploi_du_temps.destroy', ['emploi_du_temp' => $e->id]) }}"
