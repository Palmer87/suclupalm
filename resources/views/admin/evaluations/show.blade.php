                ...
                <div class="info-table table-responsive">
                    <table class="table text-nowrap">
                        <tbody>
                            ...
                            <tr>
                                <td>Enseignant:</td>
                                <td class="font-medium text-dark-medium">{{ $evaluation->enseignant->nom }} {{ $evaluation->enseignant->prenom }}</td>
                            </tr>
                            <tr>
                                <td>Date:</td>
                                <td class="font-medium text-dark-medium">{{ \Carbon\Carbon::parse($evaluation->date_evaluation)->format('d/m/Y') }}</td>
                            </tr>
                            <tr>
                                <td>Type:</td>
                ...
                <tbody>
                    @foreach($students as $student)
                        ...
                        <tr>
                            ...
                            <td>
                                @if($note)
                                    <span class="font-weight-bold {{ $note->note < ($evaluation->note_max / 2) ? 'text-danger' : 'text-success' }}">
                                        {{ $note->note }}
                                    </span>
                                @else
