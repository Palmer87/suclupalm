...
<div class="breadcrumbs-area">
    ...
    <ul>
        ...
        <li>
            <a href="{{ route('admin.bulletins.generate', $classe->id) }}">{{ $classe->nom }}</a>
        </li>
    ...
    <div class="card-body">
        <div class="heading-layout1">
            <div class="item-title">
                <h3>Bulletin - {{ $annee->annee }}</h3>
            </div>
            <div class="dropdown">
                <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false">...</a>
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="#" onclick="window.print()"><i class="fas fa-print"></i> Imprimer</a>
                    <a class="dropdown-item" href="{{ route('admin.bulletins.generate', $classe->id) }}"><i class="fas fa-arrow-left"></i> Retour</a>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4 border-bottom pb-3">
            <div class="col-md-2 text-center">
                 @if($bulletin['student']->photo)
                    <img src="{{ asset('storage/'.$bulletin['student']->photo) }}" alt="student" class="rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                @else
                    <div class="rounded-circle bg-light d-flex align-items-center justify-content-center text-secondary mx-auto" style="width: 100px; height: 100px; font-size: 2rem; font-weight: bold;">
